...
public class WebTable {
  ...
  public void openWebSite() {
	  ...
	  driver.get("file:///D:/Excel_Handling/Excel/webtable.html");
  }
  @Test
  public void webTable() throws IOException {
	  ...
	  int allRowsWeb = driver.findElements(By.xpath("/html/body/table/tbody/tr")).size();
	  ...
	  int allColumnsWeb = driver.findElements(By.xpath("/html/body/table/tbody/tr[1]/td")).size();
	  ...
	  HSSFSheet sheet = workbook.getSheet("WebTable1");
